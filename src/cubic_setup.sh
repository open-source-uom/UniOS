#Author: Ioannis Michadasis, <cs05415@uowm.gr>
# PLEASE HAVE unios.jpg (the wallpaper), unios.png (2d unios icon) and unidesk_1.0-1_all.deb IN
# custom-root/tmp BEFORE STARTING

# 1. Copy wallpaper (drag unios.jpg onto Cubic first, then:)
mkdir -p /usr/share/wallpapers/MyWallpaper/contents/images
cp /root/unios.jpg /usr/share/wallpapers/MyWallpaper/contents/images/unios.jpg

# 2. Copy unios.png icon (drag unios.png onto Cubic first, then:)
mkdir -p /usr/share/icons/hicolor/256x256/apps
cp /root/unios.png /usr/share/icons/hicolor/256x256/apps/unios.png
...
# 11. Install unidesk
apt install -y /root/unidesk_1.0-1_all.deb
